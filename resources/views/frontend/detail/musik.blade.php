...
{{-- HERO --}}
@php
    $fotoEvent = $event['foto_event_url'] ?? null;
    $bgImage = $fotoEvent
        ? $fotoEvent
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-10">
        ...
        <div class="lg:col-span-3 space-y-8">
            ...
            <div class="flex flex-wrap items-center gap-4 text-lg font-semibold mt-4">
                ...
                <span class="bg-gray-800 text-white px-3 py-2 rounded-lg flex items-center">
                    ⏰ {{ $event['waktu_perform'] ?? 'Waktu belum ditentukan' }}
                </span>
                ...
                <span class="bg-gray-800 text-white px-3 py-2 rounded-lg flex items-center">
                    🎶 {{ $event['genre'] ?? 'Genre belum ditentukan' }}
                </span>
            </div>
            ...
            {{-- Video --}}
            @php
                $videoUrl = $event['link_video'] ?? null;
                $youtubeId = null;
                if ($videoUrl) {
