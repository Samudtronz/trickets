...
<section class="relative h-[90vh] flex items-center justify-start bg-cover bg-center"
    style="background-image: linear-gradient(rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url('{{ asset('assets/images/backgrounds/coachella.png') }}');">
    ...
    <div class="container mx-auto px-6 relative z-10 animate-fade-in-up">
        <div class="max-w-2xl space-y-6">
            ...
            <h1 class="text-6xl lg:text-7xl font-black text-white">COACHELLA</h1>
...
<section class="bg-black py-16 px-6 lg:px-20">
    ...
    <div class="space-y-6">
        {{-- Event Card --}}
        @foreach ([
            ['title' => 'Radiohat World Tour', 'lokasi' => 'Stadion Utama Riau', 'waktu' => '19:00 WIB, 22 Februari 2022'],
            ['title' => 'Rolling Stove Music Fest', 'lokasi' => 'Lapangan MTQ Pekanbaru', 'waktu' => '20:00 WIB, 23 Februari 2022'],
            ['title' => 'Konser Super Epic', 'lokasi' => 'Bandar Serai', 'waktu' => '18:30 WIB, 24 Februari 2022'],
        ] as $event)
